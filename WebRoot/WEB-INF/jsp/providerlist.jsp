...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/providerList.html">
				...
				<a href="${pageContext.request.contextPath }/provider/showCreated.html">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
...
<div class="page-bar">
		<ul class="page-num-ul clearfix">
			<li>共${pageBean.totalCount }条记录&nbsp;&nbsp; ${pageBean.pageNo
				...
				href="${pageContext.request.contextPath }/provider/providerList.html?pageNo=1&queryProCode=${queryProCode}&queryProName=${queryProName}">首页</a>
				<a
				href="${pageContext.request.contextPath }/provider/providerList.html?pageNo=${pageBean.pageNo-1}&queryProCode=${queryUserName}&queryProName=${queryProName}">上一页</a>
				<a
				href="${pageContext.request.contextPath }/provider/providerList.html?pageNo=${pageBean.pageNo+1}&queryProCode=${queryUserName}&queryProName=${queryProName}">下一页</a>
				<a
				href="${pageContext.request.contextPath }/provider/providerList.html?pageNo=${pageBean.totalPages }&queryProCode=${queryUserName}&queryProName=${queryProName}">最后一页</a>
			</li>
		</ul>
