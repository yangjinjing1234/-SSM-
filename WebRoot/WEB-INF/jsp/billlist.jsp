	...
	<div class="search">
		<form method="get"
			...
			<span>商品名称：</span> <input name="queryProductName" type="text"
				...
				href="${pageContext.request.contextPath }/bill/billadd.html">添加订单</a>
		</form>
	</div>
	<!--账单表格 样式和供应商公用-->
	...
	<div class="page-bar">
		<ul class="page-num-ul clearfix">
			<li>共${pageBean.totalCount }条记录&nbsp;&nbsp; ${pageBean.pageNo
				...
				href="${pageContext.request.contextPath }/bill/billList.html?pageNo=1&queryProductName=${queryProductName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">首页</a>
				<a
				href="${pageContext.request.contextPath }/bill/billList.html?pageNo=${pageBean.pageNo-1}&queryProductName=${queryUserName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">上一页</a>
				<a
				href="${pageContext.request.contextPath }/bill/billList.html?pageNo=${pageBean.pageNo+1}&queryProductName=${queryUserName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">下一页</a>
				<a
				href="${pageContext.request.contextPath }/bill/billList.html?pageNo=${pageBean.totalPages }&queryProductName=${queryUserName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">最后一页</a>
			</li>
		</ul>
