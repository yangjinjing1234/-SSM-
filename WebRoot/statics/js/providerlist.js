...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/provider/delProvider/"+obj.attr("proid"),
		dataType:"json",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/provider/showProvider.html?id="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/provider/showModify.html?id="+ obj.attr("proid");
	});
